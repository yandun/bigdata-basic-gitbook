...
```
hostnamectl  set-hostname namenode-01
```
...
ssh-copy-id namenode-01
ssh-copy-id namenode-02

ssh-copy-id datanode-01
ssh-copy-id datanode-02
ssh-copy-id datanode-03
...
```
scp /root/.ssh/id_rsa  namenode-02:/root/.ssh/
```
...
```
cat  >  /usr/local/hadoop-2.7.4/etc/hadoop/slaves  << EOF
datanode-01
datanode-02
datanode-03
EOF
